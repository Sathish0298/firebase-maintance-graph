...
def monitor_sensor_data():
    ...
    while True:
        ...
        time.sleep(5)  # ✅ Auto-refresh every 1 minute
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://firebase-maintance-graph0298.streamlit.app/?refresh_time=1742031021" target="_blank">Graph View</a>
                        </li>
                    </ul>
                </div>
            </div>
